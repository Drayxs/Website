		...
		<tr>
			<td class = "projectDescriptionSide">
				<p style = "text-align: left;">
					...
					<b>Duration:</b> February 2017 - June 2017<br>
			...
			<td class = "projectVideoSide">
				<div class = "youtube-container">
					<div class = "youtube-player" data-id = "XZCeDlu1BGo"></div>					
				</div>
			</td>
		</tr>
	</table>
...
<div>
	<h2>MaXit Education</h2>
	<table>
		<tr>
			<td class = "projectDescriptionSide">
				<p style = "text-align: left;">
					<b>Role:</b> Software Developer Intern (<a href = "https://www.facebook.com/BeaconWallLtd/" target = "_blank">BeaconWall</a>)<br>
					<b>Duration:</b> June 2012 - September 2012<br>
			...
			<td class = "projectVideoSide">
				<div class = "youtube-container">
					<div class = "youtube-player" data-id = "vC_uhwGmgRM"></div>
				</div>
			</td>
		</tr>
	</table>
